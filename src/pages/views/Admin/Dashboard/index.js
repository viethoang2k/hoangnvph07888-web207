    ...
    <div className="col-lg-6 mb-4">
      ...
      <div className="card shadow mb-4">
        ...
        <div className="card-body">
          ...
          <p>Add some quality, svg illustrations to your project courtesy of , a constantly updated collection of beautiful svg images that you can use completely free and without attribution!</p>
        </div>
      </div>
      {/* Approach */}
      <div className="card shadow mb-4">
